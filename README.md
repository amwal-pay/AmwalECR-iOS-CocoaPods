...
> **Using Swift Package Manager instead?** The same sources are published as a
> Swift package from [AmwalECR-iOS-SPM](https://github.com/amwal-pay/AmwalECR-iOS-SPM).
